...
public class StudentOrderDaoImpl implements StudentOrderDao {
    ...
    private static final String INSERT_ORDER =
            "INSERT INTO public.jc_student_order(" +
                    ...
                    "h_extension, h_apartmnet, h_university_id, h_student_number, w_sur_name, " +
...
//        return getStudentOrdersTwoSelect();
    ...
    private Adult fillAdult(ResultSet rs, String pref) throws SQLException {
        ...
        PassportOffice po =
                new PassportOffice(poId, poArea, poName);
        ...
        ad.setApartment(rs.getString(pref + "apartmnet"));
        adult.setAddress(ad);
    ...
    private Child fillChild(ResultSet rs) throws SQLException {
        ...
        ad.setApartment(rs.getString("c_apartmnet"));
        child.setAddress(ad);
        return child;
    }
